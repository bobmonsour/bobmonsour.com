...
The [microblog](/microblog/) **no longer** has its own RSS feed. I ~~may~~ **did** change **my mind and now** the [main feed](/feed.xml) ~~to~~ also include*s* these posts.~~, but for now the main blog and this thing will have separate feeds.~~
