...
![IBM PC from the 1980s](/assets/img/ibm-pc.jpg)

Photo by [bert b](https://unsplash.com/@bertsz) {.caption}
...
![a burning cigarette sitting on a ledge](/assets/img/burning-ciagarette.jpg)

Photo by [Andres Siimon](https://unsplash.com/@johnmcclane) {.caption}
